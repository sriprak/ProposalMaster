...
/**
 * Servlet implementation class BusinessControlServlet
 */
@WebServlet("/BusinessControlServlet")
public class BusinessControlServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String file = "Business Control Functions.docx";
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\Business Control Functions Reports\\Business_Control_Functions_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadBizCntrlServlet");
