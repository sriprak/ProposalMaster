...
/**
 * Servlet implementation class PartnershipProgramServlet
 */
@WebServlet("/PartnershipProgramServlet")
public class PartnershipProgramServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public PartnershipProgramServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		final double adminfee = Double.parseDouble(request
				.getParameter("adminfee"));
		final double travelexp = Double.parseDouble(request
				.getParameter("travelexp"));
		...
		try {
			...
			String file = "Partnership Program Proposal.docx";
			...
			docx4j.searchAndReplace(texts, new HashMap<String, Object>() {
				...
				private static final long serialVersionUID = 1L;
				{
					...
					this.put("${ adminfee }", adminfee);
					this.put("${ travelexp }", travelexp);
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\Partnership Program Reports\\Partnership_Program_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadPPPServlet");
