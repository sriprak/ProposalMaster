...
/**
 * Servlet implementation class AdmOutServlet
 */
@WebServlet("/AdmOutServlet")
public class AdmOutServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdmOutServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String file = "Administration Outsourcing.docx";
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\Administration Outsourcing Reports\\Administration_Outsourcing_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadAdmOutServlet");
