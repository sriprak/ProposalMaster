...
/**
 * Servlet implementation class CmpSecMatServlet
 */
@WebServlet("/CmpSecMatServlet")
public class CmpSecMatServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CmpSecMatServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String file = "Company Secretarial matters.docx";
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\Company Secretarial Matters Reports\\CmpSecMatters_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadCmpSecServlet");
