...
/**
 * Servlet implementation class FinanceDDServlet
 */
@WebServlet("/FinanceDDServlet")
public class FinanceDDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public FinanceDDServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String file = "Financial Due Dilligence.docx";
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\Financial Due Dilligence Reports\\Financial_Due_Dilligence_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadFddServlet");
