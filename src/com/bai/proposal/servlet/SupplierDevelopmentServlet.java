...
/**
 * Servlet implementation class SupplierDevelopmentServlet
 */
@WebServlet("/SupplierDevelopmentServlet")
public class SupplierDevelopmentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SupplierDevelopmentServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String file = "Supplier Development.docx";
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\Supplier Development Reports\\Supplier_Development_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadSuppDevServlet");
