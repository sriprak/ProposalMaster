...
/**
 * Servlet implementation class LegalDDServlet
 */
@WebServlet("/LegalDDServlet")
public class LegalDDServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public LegalDDServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String file = "Legal Due Dilligence.docx";
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\Legal Due Dilligence Reports\\Legal_Due_Dilligence_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadLegddServlet");
