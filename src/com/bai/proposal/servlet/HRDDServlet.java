...
/**
 * Servlet implementation class HRDDServlet
 */
@WebServlet("/HRDDServlet")
public class HRDDServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			String file = "HR Due Dilligence.docx";
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\HR Due Dilligence Reports\\HR_Due_Dilligence_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadHrddServlet");
