...
/**
 * Servlet implementation class CompRegServlet
 */
@WebServlet("/CompRegServlet")
public class CompRegServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CompRegServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		final double statAmt = Double.parseDouble(request
				.getParameter("statAmt"));
		...
		try {
			...
			String file = "Company Registration.docx";
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\Company Registration Reports\\Company_Registration_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadCmpRegServlet");
