 ...
 */
@WebServlet("/PartnerSearchServlet")
public class PartnerSearchServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		final String scpWrk = request.getParameter("scopeWork");
		...
		try {
			...
			String file = "Partner Search.docx";
			...
			docx4j.writeDocxToStream(
					template,
					"C:\\Users\\BAI-MUM\\Desktop\\Reports\\Partner Search Reports\\Partner_Search_"
							+ shortName + ".docx");
		} catch (Exception e) {
		...
		RequestDispatcher rd = request.getRequestDispatcher("FileUploadPartSrchServlet");
