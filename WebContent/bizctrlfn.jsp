...
<title>Business Control Functions Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.bizCntlForm.servTax.value = (document.bizCntlForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.bizCntlForm.proffee.value) * 1.00;
		var y = (document.bizCntlForm.servTax.value) * 1.00;
		var z = (document.bizCntlForm.ope.value) * 1.00;
		document.bizCntlForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Business Control Functions Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="BusinessControlServlet" id="bcId" name="bizCntlForm"
		method="post">
