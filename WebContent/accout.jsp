...
<title>Accounting Outsourcing Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.accOutForm.servTax.value = (document.accOutForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.accOutForm.proffee.value) * 1.00;
		var y = (document.accOutForm.servTax.value) * 1.00;
		var z = (document.recruitForm.ope.value) * 1.00;
		document.recruitForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Accounting Outsourcing Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="AccOutServlet" id="aoId" name="accOutForm" method="post">
		<table align="center" id="oneTimeTable">
			...
			<tr>
				<td>Effective Start Date of Assignment</td>
				<td>:</td>
				<td><input type="text" id="esdId" name="effStrtDate"
					width="304px" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>:</td>
				<td><input type="text" id="otId" name="oneTimeFee"
					width="304px" /></td>
			</tr>
			<tr>
				<td>Service Tax (in Euros)</td>
				<td>:</td>
				<td><input type="text" id="stId" name="servTax" width="304px" /><input
					type="button" value="CALCULATE" onclick="calculateST();" /></td>
			</tr>
			<tr>
			...
			<!-- <tr>
				...
				<td><input type="text" id="totAmtId" name="totalAmt"
					width="304px" /><input type="button" value="CALCULATE"  onclick="calculateTotal();" /></td>
			</tr> -->
			<tr>
