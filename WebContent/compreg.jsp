...
<title>Company Registration Proposal Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.compRegForm.servTax.value = (document.compRegForm.proffee.value)
				* (12.36 / 100);
		return true;
	}
...
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Company Registration Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="CompRegServlet" id="crId" name="compRegForm"
		method="post">
		<table align="center" id="oneTimeTable">
			...
			<tr>
				...
				<td>:</td>
				<td><input type="text" id="statAmtId" name="statAmt"
