...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.postRegForm.servTax.value = (document.postRegForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.postRegForm.proffee.value) * 1.00;
		var y = (document.postRegForm.servTax.value) * 1.00;
		var z = (document.postRegForm.ope.value) * 1.00;
		document.postRegForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Post Registration Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="PostRegistrationServlet" id="prId" name="postRegForm"
		method="post">
