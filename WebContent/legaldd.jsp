...
<title>Legal Due Diligence Proposal Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.legalDDForm.servTax.value = (document.legalDDForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.legalDDForm.proffee.value) * 1.00;
		var y = (document.legalDDForm.servTax.value) * 1.00;
		var z = (document.legalDDForm.ope.value) * 1.00;
		document.legalDDForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Legal Due Diligence Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="LegalDDServlet" id="lddId" name="legalDDForm"
		method="post">
