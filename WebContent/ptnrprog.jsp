...
<title>Partnership Program Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.ptnrProgForm.servTax.value = (document.ptnrProgForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.ptnrProgForm.proffee.value) * 1.00;
		var y = (document.ptnrProgForm.adminfee.value) * 1.00;
		var z = (document.ptnrProgForm.travelexp.value) * 1.00;
		document.ptnrProgForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Partnership Program Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="PartnershipProgramServlet" id="pppId" name="ptnrProgForm"
		method="post">
		<table align="center" id="oneTimeTable">
			...
			<tr>
				<td>Administration Fee (in Euros)</td>
				<td>:</td>
				<td><input type="text" id="afId" name="adminfee" width="304px" />
					<!-- <input type="button" value="CALCULATE"  onclick="calculateST();" /> --></td>
			</tr>
			<tr>
				<td>Travel Expenses (in Euros)</td>
				<td>:</td>
				<td><input type="text" id="teId" name="travelexp" width="304px" /></td>
			</tr>
			<tr>
