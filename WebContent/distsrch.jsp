...
<title>Distributor Search Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.distSrchForm.servTax.value = (document.distSrchForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.distSrchForm.proffee.value) * 1.00;
		var y = (document.distSrchForm.servTax.value) * 1.00;
		var z = (document.distSrchForm.ope.value) * 1.00;
		document.distSrchForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Distributor Search Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="DistributorSearchServlet" id="dsId" name="distSrchForm"
		method="post">
