...
<title>Recruitment Proposal Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.recruitForm.servTax.value = (document.recruitForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.recruitForm.proffee.value) * 1.00;
		var y = (document.recruitForm.servTax.value) * 1.00;
...
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Recruitment Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="RecruitmentServlet" id="recId" name="recruitForm"
		method="post">
