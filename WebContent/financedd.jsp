...
<title>Financial Due Diligence Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.finDDForm.servTax.value = (document.finDDForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.finDDForm.proffee.value) * 1.00;
		var y = (document.finDDForm.servTax.value) * 1.00;
		var z = (document.finDDForm.ope.value) * 1.00;
		document.finDDForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Financial Due Diligence Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="FinanceDDServlet" id="fddId" name="finDDForm"
		method="post">
