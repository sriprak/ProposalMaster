...
<title>Company Secretarial Matters Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.cmpSecMForm.servTax.value = (document.cmpSecMForm.proffee.value)
				* (12.36 / 100);
		return true;
	}
...
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Company Secretarial Matters Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="CmpSecMatServlet" id="csmId" name="cmpSecMForm"
		method="post">
		<table align="center" id="oneTimeTable">
			...
			<tr>
				<td>Statutory Amount (in Euros)</td>
				<td>:</td>
				<td><input type="text" id="saId" name="statAmt" width="304px" /></td>
			</tr>
			<tr>
