...
<title>HR Due Diligence Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.hrDDForm.servTax.value = (document.hrDDForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.hrDDForm.proffee.value) * 1.00;
		var y = (document.hrDDForm.servTax.value) * 1.00;
		var z = (document.hrDDForm.ope.value) * 1.00;
		document.hrDDForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">HR Due Diligence Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="HRDDServlet" id="hrddId" name="hrDDForm" method="post">
