...
<title>Location Study Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.locStdForm.servTax.value = (document.locStdForm.proffee.value)
				* (10.3 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.locStdForm.proffee.value) * 1.00;
		var y = (document.locStdForm.servTax.value) * 1.00;
		var z = (document.locStdForm.ope.value) * 1.00;
		document.locStdForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Location Study Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="LocationStudyServlet" id="lsId" name="locStdForm"
		method="post">
		<table align="center" id="oneTimeTable">
			...
			<tr>
				<td>ManDays required</td>
				<td>:</td>
				<td><input type="text" id="manDayId" name="manDay"
					width="304px" /></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Advertisements Cost (in Euros)</td>
				<td>:</td>
				<td><input type="text" id="acId" name="advFee" width="304px" /></td>
			</tr>
			<tr>
		...
		<table align="center" id="submitTable">
			<tr>
				<td><input type="submit" id="mktId" name="submit"
					value="SUBMIT" /></td>
