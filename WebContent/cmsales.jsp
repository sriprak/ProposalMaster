...
<title>Country Manager - Sales Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.supSrchForm.servTax.value = (document.supSrchForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.supSrchForm.proffee.value) * 1.00;
		var y = (document.supSrchForm.servTax.value) * 1.00;
		var z = (document.supSrchForm.ope.value) * 1.00;
		document.supSrchForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Country Manager - Sales Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="CountryMgrServlet" id="cmId" name="cntyMgrForm"
		method="post">
		<table align="center" id="oneTimeTable">
			...
			<tr>
				<td>One Time Fee (in Euros)</td>
				<td>:</td>
				<td><input type="text" id="otfId" name="oneTimeFee"
					width="304px" /></td>
			</tr>
			<tr>
				<td>Operational Amount (in Euros)</td>
				<td>:</td>
				<td><input type="text" id="opaId" name="opAmt" width="304px" /></td>
			</tr>
			<tr>
				<td>Commission Percentage on sales</td>
				<td>:</td>
				<td><input type="text" id="cpId" name="commPer" width="304px" />
			...
			<tr>
				<td>Visit Amount (in Euros)</td>
				<td>:</td>
				<td><input type="text" id="vaId" name="visitAmt" width="304px" />
					<!-- <input type="button" value="CALCULATE"  onclick="calculateTotal();" /> --></td>
			</tr>
			<tr>
