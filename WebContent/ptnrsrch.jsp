...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.ptnrSrchForm.servTax.value = (document.ptnrSrchForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.ptnrSrchForm.proffee.value) * 1.00;
		var y = (document.ptnrSrchForm.servTax.value) * 1.00;
		var z = (document.ptnrSrchForm.ope.value) * 1.00;
		document.ptnrSrchForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<br>
	<form action="PartnerSearchServlet" id="psId" name="ptnrSrchForm"
		method="post">
