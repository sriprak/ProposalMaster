...
<title>Market Research Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.mktRschForm.servTax.value = (document.mktRschForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.mktRschForm.proffee.value) * 1.00;
		var y = (document.mktRschForm.servTax.value) * 1.00;
		var z = (document.mktRschForm.ope.value) * 1.00;
		document.mktRschForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Market Research Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="MarketResearchServlet" id="mrId" name="mktRschForm"
		method="post">
