...
<title>Supplier Development Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.suppDevForm.servTax.value = (document.suppDevForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.suppDevForm.proffee.value) * 1.00;
		var y = (document.suppDevForm.servTax.value) * 1.00;
		var z = (document.suppDevForm.ope.value) * 1.00;
		document.suppDevForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Supplier Development Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="SupplierDevelopmentServlet" id="sdId" name="suppDevForm"
		method="post">
