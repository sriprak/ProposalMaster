...
<title>Administration Outsourcing Page</title>
<style>
a:visited {
	color: blue;
}
...
<script type="text/javascript">
	...
	function calculateST() {
		...
		document.admOutForm.servTax.value = (document.admOutForm.proffee.value)
				* (12.36 / 100);
		return true;
	}

	function calculateTotal() {
		var x = (document.admOutForm.proffee.value) * 1.00;
		var y = (document.admOutForm.servTax.value) * 1.00;
		var z = (document.admOutForm.ope.value) * 1.00;
		document.admOutForm.totalAmt.value = x + y + z;
		return true;
	}
</script>
</head>
<body bgcolor="#99CCFF">
	...
	<h3 align="center">Administration Outsourcing Proposal Fields</h3>
	<center>
		<font size="3" color="red">Please fill in the required details</font>
	</center>
	<br>
	<form action="AdmOutServlet" id="adoId" name="admOutForm" method="post">
		<table align="center" id="oneTimeTable">
			...
			<!-- <tr>
				...
				<td>:</td>
				<td><input type="text" id="otId" name="oneTimeFee" width="304px" /></td>
			</tr> -->
			<tr>
